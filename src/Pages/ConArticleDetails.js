...
export default class Register extends Component {
  render() {
    return (
      <div>
        <TitleStats style={{ marginBottom: "1px" }} />

        <div container style={{ width: "85%", margin: "auto" }}>
          <ArticleDetails style={{ marginTop: "1px" }} />
          <img src="otak.jpeg" style={{ width: "100%", height: "500px" }} />
          <center>
            <Link>Books</Link>
          </center>
          ...
          <Grid
            container
            style={{ width: "70%", margin: "auto", textAlign: "justify" }}
          >
            <h1>Science Confirms That the Vagus Nerve Is Key to Well-being</h1>
            ...
            <p>
              ...
              or non-characteristic words etc. Contrary to popular belief, Lorem
